...
7. [💻 Çalıştırma / Kullanım Talimatları](#-çalıştırma--kullanım-talimatları)
8. [📂 Proje Klasör Yapısı (Clean Architecture)](#-proje-klasör-yapısı-clean-architecture)
9. [🔗 GitHub Proje Bağlantısı](#-github-proje-bağlantısı)
10. [📚 Kaynakça veya Yararlanılan Bağlantılar](#-kaynakça-veya-yararlanılan-bağlantılar)
11. [📘 Proje Dokümantasyonu](#-proje-dokümantasyonu)
