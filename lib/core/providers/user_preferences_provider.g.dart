...
final class UserPreferencesProvider
    extends $NotifierProvider<UserPreferences, Map<String, dynamic>> {
...
String _$userPreferencesHash() => r'07d214cf5232a01ec63caa6c3856f0b410ff134e';

abstract class _$UserPreferences extends $Notifier<Map<String, dynamic>> {
